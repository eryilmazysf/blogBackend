...
from .views import BlogPostCreateApi, BlogPostUpdateApi, BlogPostDeleteApi, BlogPostListView, BlogPostDetailView, BlogPostFeaturedView, BlogPostCategoryView, CommentListView
urlpatterns = [
